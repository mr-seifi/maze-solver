...
class DFS_Digital_Twin:
    ...
    def _backtrack(self, curr_node):
        return (
            ...
            else self._backtrack(curr_node.parent) + [curr_node.position()]
        )
    ...
    def update(self, grid):
        ...
        for step in self.get_successors(x, y):
            if self.is_valid_cell(step) and grid[step[0], step[1]] in [
                1,
                3,
            ]:  # 1: empty cell has not explored yet, 3: goal cell
